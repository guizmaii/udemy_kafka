...
object TestUtils {
  ...
  private class TestStream {
    ...
    def test[InputKey: Serializer, InputValue: Serializer, OutputKey: Deserializer, OutputValue: Deserializer, T](
  ...
  def testStream[InputKey: Serializer, InputValue: Serializer, OutputKey: Deserializer, OutputValue: Deserializer, T](
    ...
    (new TestStream).test(topologyBuilder)(inputTopic, outputTopic)(test)
